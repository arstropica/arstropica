...
/**
 * ArsTropica  Responsive Framework browser_detect.php
 * 
 * PHP version 5
 * 
 ...
 * 
 * @param string $arg   returns current browser property as an array. Eg: platform, name, version,
 * @param string $agent it is the $_SERVER['HTTP_USER_AGENT'] value
 * @since 1.0
 ...
 * 
 * @param string  $platform browser platform (OS)
 * @since 1.0
 * @return boolean true or false match
 */
