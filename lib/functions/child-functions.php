...
if (!is_child_theme()) :
    ...
    */
    function at_responsive_child_theme_styles() {
        ...
        wp_enqueue_style('at-responsive-child-style', child_template_url . '/lib/assets/css/default.css', array('at-responsive-framework-style', 'at-common-style'));
        // Minified?
        wp_enqueue_style('at-responsive-child-style-min', child_template_url . '/lib/assets/css/default.css', array('at-reponsive-framework-minified-css-assets'));
    }
