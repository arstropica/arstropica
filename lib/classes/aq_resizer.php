...
/**
 * ArsTropica  Responsive Framework aq_resizer.php
 * 
 * PHP version 5
 * 
...
if (!class_exists('Aq_Resize')) {
    ...
    class Aq_Resize {
         ...
         * @param int|float $width   Parameter 
         * @param int|float $height  Parameter 
         * @param boolean $crop    Parameter 
         * @param boolean $single  Parameter 
         * @param boolean $upscale Parameter 
         * @since 1.0
         * @return mixed   Return 
         * @access public 
         */
         ...
         * 
         * @param unknown $default Parameter 
         * @param number  $orig_w  Parameter 
         * @param number  $orig_h  Parameter 
         * @param number $dest_w  Parameter 
         * @param number $dest_h  Parameter 
         * @param boolean $crop    Parameter 
         * @since 1.0
         * @return mixed   Return 
         * @access public 
