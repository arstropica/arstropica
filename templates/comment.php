...
<div class="media-body">
    ...
    <time datetime="<?php echo comment_date('c'); ?>"><a href="<?php echo htmlspecialchars(get_comment_link($comment->comment_ID)); ?>"><?php printf(__('%1$s', $theme_namespace), get_comment_date(), get_comment_time()); ?></a></time>
