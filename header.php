<?php
/**
 * ArsTropica  Responsive Framework header.php
 * 
 * PHP version 5
 * 
...
?>
<!doctype html>
<html itemscope itemtype="http://schema.org/Product" <?php language_attributes(); ?>>
    <head>
    ...
    ?>
    <body <?php echo at_responsive_body_id(); ?> <?php body_class(); ?>>
        <header>
