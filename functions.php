    ...
    */
    function at_responsive_post_entry() {
        ...
        if (is_singular()) :
            ...
            $output .= sprintf('<p><span class="author">by <span class="author vcard" itemprop="author"><span class="fn" itemscope itemtype="http://schema.org/Person"><a class="url fn" href="%4$s" rel="author" itemprop="url"><span itemprop="name">%5$s</span></a></span></span>%6$s</span> on <span class="date"><span class="entry-date"><a href="%1$s" rel="bookmark"><time class="entry-date" datetime="%2$s" itemprop="datePublished">%3$s</time></a></span><time class="entry-date updated hidden" datetime="%2$s">' . get_the_modified_time(get_option('date_format')) . '</time></span></p>', esc_url(get_permalink()), esc_attr(get_the_date('c')), esc_html(get_the_date()), esc_url(get_author_posts_url(get_the_author_meta('ID'))), get_the_author(), $edit_post
            );
            else :
            // Archives
            $output .= sprintf('<span>by <span class="author vcard" itemprop="author"><span class="fn" itemscope itemtype="http://schema.org/Person"><a class="url fn" href="%4$s" rel="author" itemprop="url"><span itemprop="name">%5$s</span></a></span></span></span> | <span class="entry-date"><span class="date published time" title="%3$s"><a href="%1$s" rel="bookmark"><time class="entry-date" datetime="%2$s" itemprop="datePublished">%3$s</time></a></span><time class="entry-date updated hidden" datetime="%2$s">' . get_the_modified_time(get_option('date_format')) . '</time></span>', esc_url(get_permalink()), esc_attr(get_the_date('c')), esc_html(get_the_date()), esc_url(get_author_posts_url(get_the_author_meta('ID'))), get_the_author()
            );
